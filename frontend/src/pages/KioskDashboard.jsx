          ...
          <div className="animate-enter" style={{
            ...
            <div style={{ width: '100%', background: '#ffffff', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0', overflow: 'hidden', borderRadius: '12px 12px 0 0', height: 240 }}>
              <video
                ...
                muted
                playsInline
                style={{ width: '100%', height: '100%', objectFit: 'contain', backgroundColor: '#ffffff', transform: 'scale(1.45)', transformOrigin: 'top center', clipPath: 'inset(0 16% 0 16%)', display: 'block' }}
              />
            </div>
